...
export function Duck(props: Partial<GroupProps>) {
const group = useRef<Group<Object3DEventMap>>();
  const { animations, nodes, materials } = useGLTF('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/duck/model.gltf')
